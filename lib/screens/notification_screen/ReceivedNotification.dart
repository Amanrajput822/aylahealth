...
//   // Future<void> showNotificationAndroid(String title, RemoteMessage type, String body, int value) async {
...
//       print('configureSelectNotificationSubject${message}');
//       print('configureSelectNotificationSubject${json.decode(message)}');
//
//       await notificationClickLocal(json.decode(message));
//     });
//   }
// }
