...
///////////////////// customerFoodSettingData_api API /////////////////
  ...
  Future<Answer_submit_Model> add_Customer_Answer_up(String queid ,String quetype) async {
    ...
    if (success == 200) {
      ...
      Get.off(() => Food_Nutrition_Settings(screen:0));
  ...
  Future<bool> _willPopCallback() async {
    if(widget.edit != 0){
      ...
      //Navigator.pop(context);
      Get.off(() => Food_Nutrition_Settings(customerFoodSettingHeading_list:widget.customerFoodSettingHeading_list,screen:1));
    }
